namespace nGroup.Sign.Cli
{
  ...
  internal sealed class Pkcs11TokenLocalCommand : Command
  {
    ...
    // ".\nGroup.Sign.exe" code pkcs11-token-local *.dll -kvc 9505299957EED70137B0CD033DDB3F2AA027A6DB -d "eEvolution GmbH & Co. KG" -u http://eEvolution.de -kvu https://localhost:7036 -kvt spilker -kvi nGroup.Sign -kvs Ts52Xavc8hM -o signed\"
